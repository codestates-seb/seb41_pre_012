  ...
  return (
    <>
      <InnerContent>
        ...
        <StyledSection>
          <QuestionHeader>
            <QuestionTitle>Python aiogram: How to get last chat message id</QuestionTitle>
            <AskQuestion>
            ...
            <div className="post-layout">
              ...
              <QuestionBody>
                <QuestionContent>
                  ...
                  Python. I have tried using the .get_last_message() method, but it returns None. Is
                  there another way to get the last message id in a chat using aiogram?
                </QuestionContent>
                <EditUserContainer>
